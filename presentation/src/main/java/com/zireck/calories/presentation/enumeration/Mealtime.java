...
public enum Mealtime {
    BREAKFAST(1, com.zireck.calories.R.string.breakfast),
    LUNCH(2, com.zireck.calories.R.string.lunch),
    SNACK(3, com.zireck.calories.R.string.snack),
    DINNER(4, com.zireck.calories.R.string.dinner),
    OTHER(5, com.zireck.calories.R.string.other);
