...
import com.zireck.calories.presentation.util.StringUtils;
...
public class AddMealPresenter implements Presenter {
    ...
    private com.zireck.calories.domain.interactor.Interactor mGetAllFoodListInteractor;
    private com.zireck.calories.domain.interactor.AddMeal mAddMealInteractor;
    ...
    @Inject
    public AddMealPresenter(@Named("allFoodList") com.zireck.calories.domain.interactor.Interactor getAllFoodListInteractor,
                            @Named("addMeal") com.zireck.calories.domain.interactor.AddMeal addMealInteractor,
    ...
    private final class AllFoodListSubscriber extends com.zireck.calories.domain.interactor.DefaultSubscriber<List<Food>> {
        @Override
    ...
    private final class AddMealSubscriber extends com.zireck.calories.domain.interactor.DefaultSubscriber {
