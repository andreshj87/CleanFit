 ...
 */
public class AddMeal extends Interactor {
    ...
    @Inject
    public AddMeal(com.zireck.calories.domain.repository.MealRepository mealRepository, com.zireck.calories.domain.executor.ThreadExecutor threadExecutor,
    ...
    protected Observable buildInteractorObservable() {
        return mMealRepository.addMeal(mMeal);
    }
}
